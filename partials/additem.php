      ...
      <form class="form-horizontal" ng-submit="addItem()">
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-10">
              <input type="text" class="form-control" id="txtItemName" name="txtItemName" ng-model="formData.txtItemName" placeholder="Item Name">
            </div>
          </div>
          <div class="form-group">
            <label for="txtDesc" class="col-lg-2 control-label">Description</label>
            <div class="col-lg-10">
              <textarea type="text" class="form-control" id="txtDesc" name="txtDesc" ng-model="formData.txtDesc" placeholder="Description">
              </textarea>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-lg-10">
              <input type="text" class="form-control" id="txtPrice" name="txtPrice" ng-model="formData.txtPrice" placeholder="$5.55">
            </div>
          </div>
          <div class="form-group">
            <label for="numStock" class="col-lg-2 control-label">Stock</label>
            <div class="col-lg-10">
              <input type="number" min="0" class="form-control" id="numStock" name="numStock" ng-model="formData.numStock" placeholder="Stock">
            </div>
          </div>
          <div class="form-group">
